...
export DATABASE_CONFIG=postgresql+pg8000://escalation:escalation_pwd@localhost:5432/$TESTING_DATABASE
...
sqlacodegen $DATABASE_CONFIG --outfile test_app_deploy_data/models.py
