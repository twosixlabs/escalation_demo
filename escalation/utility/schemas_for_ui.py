...
def build_graphic_schemas_for_ui(data_source_names=None, column_names=None,collapse_dict=None):
    """
    ...
    :return:
    """
    graphic_schema = build_graphic_schema(data_source_names, column_names, collapse_dict)
