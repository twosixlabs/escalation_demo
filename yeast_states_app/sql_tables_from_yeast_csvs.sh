...
python database/csv_to_sql.py mysql flow_meta ../yeast_states_app/yeast_states_data_files/NovelChassis-OR-Circuit-Cycle0-24hour__fc_meta.csv
python database/csv_to_sql.py mysql growth_rate ../yeast_states_app/yeast_states_data_files/pdt_NovelChassis-OR-Circuit-Cycle0-24hour__od_growth_analysis.csv
python database/csv_to_sql.py mysql plate_reader ../yeast_states_app/yeast_states_data_files/NovelChassis-OR-Circuit-Cycle0-24hour__platereader.csv
# pivoted version of the flow_stat table
python database/csv_to_sql.py mysql flow_stat_wide ../yeast_states_app/yeast_states_data_files/wide_format_NovelChassis-OR-Circuit-Cycle0-24hour__fc_raw_log10_stats.csv
